  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <Card
          className={`h-full p-0 pt-0 pb-0 md:pt-4 m-0 gap-y-0 rounded-none md:rounded-2xl overflow-hidden flex flex-col shadow-none transition-opacity
        ...
        >
          {(error && error.message) ?
            ...
            <>
              <CardHeader className="flex flex-row justify-between pb-4 md:pb-4">
                <MainContentHeader />
                <div className="h-4 bg-gradient-to-b from-background to-transparent absolute hidden md:block md:w-[calc(100%-theme(spacing.12))] top-8 md:top-13" />
              </CardHeader>
