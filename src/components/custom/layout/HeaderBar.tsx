...
export default function HeaderBar({ title, subTitle, pills }: Props) {
  ...
  return (
    <header className="md:rounded-2xl sticky top-0 bg-border/50 backdrop-saturate-100 backdrop-blur-sm border border-b-primary/30 md:border-none px-2 z-50 mx-0 md:px-4 py-3 md:mb-4 flex items-center justify-between shrink-0">
